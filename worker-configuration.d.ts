/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: be7f9776ea8c288a83603fe0437de139)
// Runtime types generated with workerd@1.20260730.1 2026-08-01 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	VITE_REGISTRATION_ENDPOINT: string;
	VITE_FEEDBACK_ENABLED: string;
	ACTIVE_VISITORS: DurableObjectNamespace<import("./worker/index").ActiveVisitorCounter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "ActiveVisitorCounter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_REGISTRATION_ENDPOINT" | "VITE_FEEDBACK_ENABLED">> {}
}
